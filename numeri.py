...
# 25/09/2026: versione 5. Da 999.950 in su si scrive 1M e non 1000K, e un
# importo scritto cosi' grande da non essere un numero finito si rifiuta.
...
def formatta_fiches(valore):
    ...
    # Sotto il milione, ma abbastanza vicino da arrotondare a mille migliaia:
    # si scrive gia' con la M.
    if assoluto < 999_950:
